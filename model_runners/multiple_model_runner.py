...
#@date			8/31/2018
#@description	Run multiple models - Test Framework intended for iris data set but can be extended for using multiple models to classify multiple classes (Winnow2 requires multiple models for multiple classes)
