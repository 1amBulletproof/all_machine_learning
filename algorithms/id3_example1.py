...
#@author Brandon Tanrey
#@date  10/14/2018
#@src:	https://machinelearningforbeginners.wordpress.com/2017/11/23/id3-algorithm-implementation-in-python/
...
def decision_tree(data, labels):
	...
	if classList.count(classList[0]) == len(classList):
		#There is only 1 classification! No tree necessary!!
		return classList[0]
